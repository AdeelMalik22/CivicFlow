...
from apps.common.views import AccountabilityView, HomeView, HowItWorksView, ProjectCreateView, ProjectDetailView, ProjectsView, WorkspaceView, liveness, readiness
...
urlpatterns = [
    ...
    path("workspace/projects/", ProjectsView.as_view(), name="projects"),
    path("workspace/projects/create/", ProjectCreateView.as_view(), name="project-create"),
    path("workspace/projects/<int:pk>/", ProjectDetailView.as_view(), name="project-detail"),
    path(
